/**
 * In-Memory Store
 * Replaces MongoDB for users and history.
 * Data lives only while the server is running.
 */

const users   = [];   // { id, name, email, passwordHash, location, role, createdAt }
const history = [];   // { id, userId, type, input, result, createdAt }
